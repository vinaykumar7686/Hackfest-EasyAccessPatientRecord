...
class TestViewRegisteredPatients(unittest.TestCase):
    driver = setUp()
    ...
    def test_view_registered_patients(self):
        ...
        registered_patients = dhp.get_registered_patients()
        registered_patients.click()

        self.assertEqual(Config.VIEW_ALL_PATIENTS_URL,self.driver.current_url)
